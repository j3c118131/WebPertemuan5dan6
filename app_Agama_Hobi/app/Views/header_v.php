  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto"> <!-- Ngubah posisi navbar kanan kiri tengah disini -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo site_url('Beranda'); ?>">Beranda <span class="sr-only">(current)</span></a> <!--echo site_url untuk mengaddress link-->
            </li>
            <li class="nav-item">
